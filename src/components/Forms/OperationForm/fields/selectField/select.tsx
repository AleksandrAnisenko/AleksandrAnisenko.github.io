import React, { memo, OptionHTMLAttributes, ReactNode, SelectHTMLAttributes, useId } from 'react';
import cn from 'clsx';
import s from './select.module.scss';

const typedMemo: <T>(c: T) => T = memo;

export interface SelectOption<T extends string = string> extends OptionHTMLAttributes<HTMLOptionElement> {
  value: T;
  content: string;
}
